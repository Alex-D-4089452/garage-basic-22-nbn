        ...
        <div className="space-y-6">
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-zinc-50 px-2 text-zinc-400 dark:bg-zinc-950" style={{ backgroundColor: 'var(--auth-container-background-color)' }}>or</span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                    ...
                    className="w-full rounded-md bg-black px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-black dark:hover:bg-zinc-200 auth-button"
                >
            ...
            <p className="text-center text-sm text-zinc-500">
                ...
                <Link
                    href="/auth/signin"
                    className="font-medium text-zinc-900 border-b-2 border-[#36449C] dark:text-white"
                >
                    Sign in
                </Link>
            </p>
